          ...
          <div className="grid grid-cols-8 grid-rows-40 grid-rows w-full h-fit divide-x">
            <div className="divide-y divide-white">
              <div className="invisible">
                <DateHeader DayofTheMonth={99} DayofTheWeek={"XXX"} />
              </div>
  ...
  function TimeCell({ Time }) {
    return (
      <div className="w-full hover:bg-gray-50">
        <p className="cursor-pointer opacity-0 hover:opacity-100 text-gray-400">
          {Time}
        </p>
      </div>
    );
